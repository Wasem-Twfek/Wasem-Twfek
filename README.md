...
### Software Engineer · AI/ML · Full-Stack · Data
...
I work mainly with **Python and TypeScript**, building applications that connect software engineering with AI, data, and real user workflows.

My current interests include:

- **AI & Machine Learning** — NLP, speech processing, applied ML, Gemini
- **Full-Stack Development** — React, Next.js, TypeScript, Node.js
- **Backend & Data** — Express, Django, Flask, PostgreSQL, Supabase, Prisma, Redis
- **Engineering & DevOps** — Docker, GitHub Actions, CI/CD, Linux, testing
...
- **Interests:** AI/ML, NLP, speech processing, data engineering
- **Development:** APIs, web applications, databases, distributed services
- **Engineering:** testing, CI/CD, Docker, maintainable codebases
